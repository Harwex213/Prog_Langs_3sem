...
#define GRAPHES \
FST::UNIQUE_DATA idata1  = { LEX_INTEGER,	   IT::INT,		IT::P };\
FST::UNIQUE_DATA idata2  = { LEX_STRING,	   IT::STR,		IT::P };\
FST::UNIQUE_DATA idata3  = { LEX_FUNCTION,	   IT::UNDEF,	IT::F };\
FST::UNIQUE_DATA idata4  = { LEX_DECLARE,	   IT::UNDEF,	IT::V };\
FST::UNIQUE_DATA idata5  = { LEX_RETURN,	   IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata6  = { LEX_PRINT,		   IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata7  = { LEX_MAIN,		   IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata8  = { LEX_SEMICOLON,    IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata9  = { LEX_COMMA,	       IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata10 = { LEX_LEFTHESIS,    IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata11 = { LEX_RIGHTHESIS,   IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata12 = { LEX_LEFTBRACE,    IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata13 = { LEX_RIGHTBRACE,   IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata14 = { LEX_LITERAL,	   IT::INT,		IT::L };\
FST::UNIQUE_DATA idata15 = { LEX_LITERAL,	   IT::STR,		IT::L };\
FST::UNIQUE_DATA idata16 = { LEX_COMPUTATION,  IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata17 = { LEX_EQUAL_SIGN,   IT::UNDEF,	IT::U };\
FST::UNIQUE_DATA idata18 = { LEX_ID,		   IT::UNDEF,	IT::U };\
