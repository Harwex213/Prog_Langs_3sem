...
#define GRAPH_INT_LITERAL_INDEX 33
#define GRAPH_FLOAT_LITERAL_INDEX 34
#define GRAPH_STRING_LITERAL_INDEX 35
...
namespace Graphs
{
	struct GRAPHS
	{
		...
		GRAPHS()
		{
			...
			fstArray[GRAPH_INT_LITERAL_INDEX].idDataType = IT::UINT;
