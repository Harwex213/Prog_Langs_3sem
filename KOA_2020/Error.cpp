...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY+1] =
	{
		...
		ERROR_ENTRY(141, "SURPRISE"),
		ERROR_ENTRY(142, "SURPRISE"),
		ERROR_ENTRY(143, "SURPRISE"),
		ERROR_ENTRY(144, "SURPRISE"),
		...
		ERROR_ENTRY(402, "Неверный параметр возвращаемого типа"),
		ERROR_ENTRY(403, "Превышено максимальное количество параметров функции (не больше 16)"),
		ERROR_ENTRY(404, "Несоответствие типов формальных и фактических параметров при вызове функции"),
		ERROR_ENTRY(405, "Ошибка в выражении"),
		ERROR_ENTRY(406, "Вызов необъявленной функции"),
		ERROR_ENTRY(407, "Использован запрещенный оператор с данными операндами"),
		ERROR_ENTRY(408, "Несоответствие типов формальных и фактических параметров при вызове функции"),
		ERROR_ENTRY(409, "Несоответствие типов формальных и фактических параметров при вызове функции"),
