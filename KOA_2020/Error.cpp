...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY+1] =
	{
		...
		ERROR_ENTRY(121, "SURPRISE"),
		ERROR_ENTRY(122, "Ошибка при лексическом анализе: Неправильная лексика ключевого слова"),
		...
		ERROR_ENTRY(141, "Необъявленный идентификатор"),
