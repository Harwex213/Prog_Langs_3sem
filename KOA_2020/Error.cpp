...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY+1] =
	{
		...
		ERROR_ENTRY(403, "SURPRISE"),
		ERROR_ENTRY(404, "Выход за диапазон допустимых целочисленных значений"),
		ERROR_ENTRY(405, "Выход за диапазон допустимого строкового значения"),
		ERROR_ENTRY(406, "Выход за диапазон допустимых вещественных значений"),
		ERROR_ENTRY(407, "SURPRISE"),
		ERROR_ENTRY(408, "SURPRISE"),
		ERROR_ENTRY(409, "SURPRISE"),
		ERROR_ENTRY(410, "SURPRISE"),
		ERROR_ENTRY(411, "SURPRISE"),
		ERROR_ENTRY(412, "SURPRISE"),
